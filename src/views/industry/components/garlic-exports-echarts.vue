  ...
  watch: {
    cdata: {
      handler() {
        let allData = {
          citys: [
            { name: '徐州', value: [117.584811, 34.261792, 100] },
            ...
            itemStyle: {
              ...
              areaColor: {
                ...
                colorStops: [
                  {
                    offset: 0,
                    color: 'RGBA(2, 55, 124, 1)', // 0% 处的颜色
                  },
                  {
                    offset: 1,
                    color: 'RGBA(1, 113, 209, 0.5)', // 100% 处的颜色
                  },
                ],
                globalCoord: false, // 缺省为 false
              },
              shadowColor: 'rgba(55, 117, 202, 0.7)',
              // shadowOffsetX: 1,
              // shadowOffsetY: 1,
              emphasis: {
                show: false,
                areaColor: 'rgba(0, 65, 145, 0.8)',
              },
            },
          },
          series: [
